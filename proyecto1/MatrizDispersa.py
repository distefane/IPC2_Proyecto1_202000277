...
class MatrizDispersa():
        ...
        while pivote != None:
            ...
            while pivote_celda != None:
                ...
                while pivotey != None:
                    ...
                    posy_celda += 1
                    pivotey = pivotey.siguiente
                if pivote_celda.caracter == 'a':
                    contenido += '\n\tnode[label="a" fillcolor="green" pos="{},-{}!" shape=box]i{}_{};'.format( 
    ...
    def graficarRegalo(self, nombre):
        contenido = '''digraph G{
        node[shape=box, width=0.7, height=0.7, fontname="Arial", fillcolor="white", style=filled]
        edge[style = "bold"]
        node[label = "capa:''' + str(self.capa) +'''" fillcolor="darkolivegreen1" pos = "-1,1!"]raiz;'''
        ...
        while pivote != None:
            ...
            while pivote_celda != None:
                ...
                while pivotey != None:
                    ...
                    posy_celda += 1
                    pivotey = pivotey.siguiente
                if pivote_celda.caracter == 'r':
                    contenido += '\n\tnode[label="r" fillcolor="red" pos="{},-{}!" shape=box]i{}_{};'.format( 
                        posy_celda, posx, pivote_celda.coordenadaX, pivote_celda.coordenadaY
                    )
                else:
                    contenido += '\n\tnode[label=" " fillcolor="white" pos="{},-{}!" shape=box]i{}_{};'.format( 
    ...
    def graficarEstrella(self, nombre):
        contenido = '''digraph G{
        node[shape=box, width=0.7, height=0.7, fontname="Arial", fillcolor="white", style=filled]
        edge[style = "bold"]
        node[label = "capa:''' + str(self.capa) +'''" fillcolor="darkolivegreen1" pos = "-1,1!"]raiz;'''
        ...
        while pivote != None:
            ...
            while pivote_celda != None:
                ...
                if pivote_celda.caracter == 'e':
                    contenido += '\n\tnode[label="e" fillcolor="yellow" pos="{},-{}!" shape=box]i{}_{};'.format( 
                        posy_celda, posx, pivote_celda.coordenadaX, pivote_celda.coordenadaY
                    )
                else:
                    contenido += '\n\tnode[label=" " fillcolor="white" pos="{},-{}!" shape=box]i{}_{};'.format( 
